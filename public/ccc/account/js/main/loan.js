...
var tpl = {
	...
	today: require('ccc/account/partials/loan/today.html'),
	undue: require('ccc/account/partials/loan/undue.html'),
	repayed: require('ccc/account/partials/loan/repayed.html'),
	overdue: require('ccc/account/partials/loan/overdue.html')
};

// 还款提示
var repayConfirmTpl = require('ccc/account/partials/loan/repayConfirm.html');

// 还款明细tpl
var repayDetailTpl = require('ccc/account/partials/loan/repayDetail.html');

// 逾期罚息tpl
var overDueFeeTpl = require('ccc/account/partials/loan/overdueFee.html');
