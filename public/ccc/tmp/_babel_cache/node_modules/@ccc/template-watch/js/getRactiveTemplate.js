"use strict";(function(n){"use strict";if(n.BCP && "function" === typeof n.BCP.prelude)return n.BCP.prelude;var e=n.requestAnimationFrame || n.setImmediate || function(n){return setTimeout(n,1);};this.QAS = (function(n){var e=n.requestAnimationFrame || n.setImmediate || function(n){return setTimeout(n,1);};var r=[].concat(n._qas_queue || []);if(n._qas_queue)delete n._qas_queue;var t=Array.prototype.slice;var u=function u(n){var e=t.call(arguments,1);if(u.loaded)o(n,e);else r.push([n,e]);return u;};u.sync = function(n){n.sync = true;return u.apply(null,arguments);};u.ready = i;u.sync.ready = i;function i(){u.loaded = true;var n;while(n = r.shift()) {o(n[0],n[1]);}}function o(r,t){if(typeof r != "function")return;r.sync?r.apply(n,t):e(function(){r.apply(n,t);});}return u;})(this);var r=n.BCP = t;function t(n){QAS(n,l([]));}t.sync = function(n){QAS.sync(n,l([]));};r.prelude = c;r.mergeModules = a;var u=0;var i=r.cache = {};var o=r.modules = {};return c;function a(n){n = n || {};for(var e in n) {if(typeof e !== "number" && n.hasOwnProperty(e)){if(!(e in o)){o[e] = n[e];if(e[0] !== "/")o["/" + e] = n[e];}}}}function f(){u += 1;e(function(){if(u >= document.querySelectorAll("script[data-common]").length){QAS.ready();}});}function c(n,e,t){r.mergeModules(n);var u=l(t);if(!t || !t.length){f();}else {var i;QAS(function(n){while(i = n.shift()) {u(i);}},t);}return u;}function l(n){return function e(r){if(!QAS.loaded){throw new Error("external libs not ready!");}var t=r;if(typeof t === "string" && t[0] === "/"){t = t.replace(/^\//,"");}var u;if(!i[t]){if(!(u = o[t])){if(!(u = o[r === "/" + t?r:t = "/" + t])){if(!(u = o[t = "/node_modules" + t])){var a=new Error("Cannot find module '" + r + "'\n\nall available modules:\n" + s().join("\n"));a.code = "MODULE_NOT_FOUND";throw a;}}}var f=i[t] = i[r] = {exports:{}};u[0].call(f.exports,function(n){var r=u[1][n];return e(r?r:"/" + n);},f,f.exports,c,o,i,n);}return i[t].exports;};}function s(){var n={};p(o,function(e,r){if(("" + r).match(/^\/?\d+$/))return;n[r.replace(/^\/(node_modules\/)?/,"")] = 1;});return m(n);}function d(n,e){var r,t;for(r = 0,t = n.length;r < t;r++) {e.call(n,n[r],k,n);}}function p(n,e){for(var r in n) {if(n.hasOwnProperty(r)){e.call(n,n[r],r,n);}}}function m(n){var e=[];p(n,function(n,r){e.push(r);});return e;}}).call(undefined,undefined)({"/ccc/templates/js/main/getRactiveTemplate.js":[function(require,module,exports){(function(global){'use strict';var action=baconflux.action;var store=baconflux.store;var subed=[];var queue=[];var connected=false;action('template','subscribe').onValue(function(filePath){if(subed.indexOf(filePath) > -1 || queue.indexOf(filePath) > -1){return;}if(connected){subed.push(filePath);sock.send(JSON.stringify({filePaths:[filePath]}));}else {queue.push(filePath);}});var SockJS=require('sockjs-client');var retryInterval=[500,1000,1000,1000,3000,3000,5000,10000,15000,30000,60000];var retryintv=retryInterval.slice(0);var reset;function connect(){var sock=new SockJS(location.protocol + '//' + location.host + '/_sockjs');sock.onopen = function(){if(queue.length){sock.send(JSON.stringify({filePaths:queue}));subed = subed.concat(queue);queue = [];}if(reset){reset = false;sock.send(JSON.stringify({filePaths:subed}));}retryintv = retryInterval.slice(0);console.log('templates websocket connected, watched files: ' + subed.join(', '));};sock.onmessage = function(e){var payload;try{payload = JSON.parse(e.data);}catch(e) {}if(payload.template){store('template','updated',payload.filePath).push(payload.template);}};sock.onclose = function(){reset = true;var intv=retryintv.length > 1?retryintv.shift():retryintv[0];console.log('templates websocket closed, retry in ' + intv + 'ms');setTimeout(connect,intv);};}connect();global.getRactiveTemplate = function(filePath,defaultTemplate){if(typeof filePath !== 'string' || !filePath.match(/^ccc\/.*\.html$/)){throw new Error('getRactiveTemplate(filePath) - filePath must start with "ccc/" and end with ".html"');}var tmpl=defaultTemplate || '';return function(){if(!(this instanceof Ractive)){return;}var ractive=this;var tw=ractive._templateWatched = ractive._templateWatched || {};if(tw[filePath]){return tmpl;}tw[filePath] = 1;action('template','subscribe').push(filePath);ractive.on('teardown',store('template','updated',filePath).onValue(function(template){tmpl = template;ractive.reset(ractive.get());}));return tmpl;};};}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"sockjs-client":"/node_modules/sockjs-client/lib/entry.js"}],"/node_modules/inherits/inherits_browser.js":[function(require,module,exports){if(typeof Object.create === 'function'){ // implementation from standard node.js 'util' module
module.exports = function inherits(ctor,superCtor){ctor.super_ = superCtor;ctor.prototype = Object.create(superCtor.prototype,{constructor:{value:ctor,enumerable:false,writable:true,configurable:true}});};}else { // old school shim for old browsers
module.exports = function inherits(ctor,superCtor){ctor.super_ = superCtor;var TempCtor=function TempCtor(){};TempCtor.prototype = superCtor.prototype;ctor.prototype = new TempCtor();ctor.prototype.constructor = ctor;};}},{}],"/node_modules/json3/lib/json3.js":[function(require,module,exports){(function(global){ /*! JSON v3.3.2 | http://bestiejs.github.io/json3 | Copyright 2012-2014, Kit Cambridge | http://kit.mit-license.org */;(function(){ // Detect the `define` function exposed by asynchronous module loaders. The
...
if(isLoader){define(function(){return JSON3;});}}).call(this);}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{}],"/node_modules/ms/index.js":[function(require,module,exports){ /**
 * Helpers.
 ...
 */function plural(ms,n,name){if(ms < n)return;if(ms < n * 1.5)return Math.floor(ms / n) + ' ' + name;return Math.ceil(ms / n) + ' ' + name + 's';}},{}],"/node_modules/process/browser.js":[function(require,module,exports){ // shim for using process in browser
...
process.cwd = function(){return '/';};process.chdir = function(dir){throw new Error('process.chdir is not supported');};process.umask = function(){return 0;};},{}],"/node_modules/querystringify/index.js":[function(require,module,exports){'use strict';var has=Object.prototype.hasOwnProperty; /**
...
// Expose the module.
//
exports.stringify = querystringify;exports.parse = querystring;},{}],"/node_modules/requires-port/index.js":[function(require,module,exports){'use strict'; /**
 ...
 * @api private
 */module.exports = function required(port,protocol){protocol = protocol.split(':')[0];port = +port;if(!port)return false;switch(protocol){case 'http':case 'ws':return port !== 80;case 'https':case 'wss':return port !== 443;case 'ftp':return port !== 22;case 'gopher':return port !== 70;case 'file':return false;}return port !== 0;};},{}],"/node_modules/sockjs-client/lib/entry.js":[function(require,module,exports){(function(global){'use strict';var transportList=require('./transport-list');module.exports = require('./main')(transportList); // TODO can't get rid of this until all servers do
if('_sockjs_onload' in global){setTimeout(global._sockjs_onload,1);}}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"./main":"/node_modules/sockjs-client/lib/main.js","./transport-list":"/node_modules/sockjs-client/lib/transport-list.js"}],"/node_modules/sockjs-client/lib/event/close.js":[function(require,module,exports){'use strict';var inherits=require('inherits'),Event=require('./event');function CloseEvent(){Event.call(this);this.initEvent('close',false,false);this.wasClean = false;this.code = 0;this.reason = '';}inherits(CloseEvent,Event);module.exports = CloseEvent;},{"./event":"/node_modules/sockjs-client/lib/event/event.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/event/emitter.js":[function(require,module,exports){'use strict';var inherits=require('inherits'),EventTarget=require('./eventtarget');function EventEmitter(){EventTarget.call(this);}inherits(EventEmitter,EventTarget);EventEmitter.prototype.removeAllListeners = function(type){if(type){delete this._listeners[type];}else {this._listeners = {};}};EventEmitter.prototype.once = function(type,listener){var self=this,fired=false;function g(){self.removeListener(type,g);if(!fired){fired = true;listener.apply(this,arguments);}}this.on(type,g);};EventEmitter.prototype.emit = function(type){var listeners=this._listeners[type];if(!listeners){return;}var args=Array.prototype.slice.call(arguments,1);for(var i=0;i < listeners.length;i++) {listeners[i].apply(this,args);}};EventEmitter.prototype.on = EventEmitter.prototype.addListener = EventTarget.prototype.addEventListener;EventEmitter.prototype.removeListener = EventTarget.prototype.removeEventListener;module.exports.EventEmitter = EventEmitter;},{"./eventtarget":"/node_modules/sockjs-client/lib/event/eventtarget.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/event/event.js":[function(require,module,exports){'use strict';function Event(eventType){this.type = eventType;}Event.prototype.initEvent = function(eventType,canBubble,cancelable){this.type = eventType;this.bubbles = canBubble;this.cancelable = cancelable;this.timeStamp = +new Date();return this;};Event.prototype.stopPropagation = function(){};Event.prototype.preventDefault = function(){};Event.CAPTURING_PHASE = 1;Event.AT_TARGET = 2;Event.BUBBLING_PHASE = 3;module.exports = Event;},{}],"/node_modules/sockjs-client/lib/event/eventtarget.js":[function(require,module,exports){'use strict'; /* Simplified implementation of DOM2 EventTarget.
...
};module.exports = function(availableTransports){transports = transport(availableTransports);require('./iframe-bootstrap')(SockJS,availableTransports);return SockJS;};}).call(this,require('_process'),typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"./event/close":"/node_modules/sockjs-client/lib/event/close.js","./event/event":"/node_modules/sockjs-client/lib/event/event.js","./event/eventtarget":"/node_modules/sockjs-client/lib/event/eventtarget.js","./event/trans-message":"/node_modules/sockjs-client/lib/event/trans-message.js","./iframe-bootstrap":"/node_modules/sockjs-client/lib/iframe-bootstrap.js","./info-receiver":"/node_modules/sockjs-client/lib/info-receiver.js","./location":"/node_modules/sockjs-client/lib/location.js","./shims":"/node_modules/sockjs-client/lib/shims.js","./utils/browser":"/node_modules/sockjs-client/lib/utils/browser.js","./utils/escape":"/node_modules/sockjs-client/lib/utils/escape.js","./utils/event":"/node_modules/sockjs-client/lib/utils/event.js","./utils/log":"/node_modules/sockjs-client/lib/utils/log.js","./utils/object":"/node_modules/sockjs-client/lib/utils/object.js","./utils/random":"/node_modules/sockjs-client/lib/utils/random.js","./utils/transport":"/node_modules/sockjs-client/lib/utils/transport.js","./utils/url":"/node_modules/sockjs-client/lib/utils/url.js","./version":"/node_modules/sockjs-client/lib/version.js","_process":"/node_modules/process/browser.js","debug":"/node_modules/sockjs-client/node_modules/debug/browser.js","inherits":"/node_modules/inherits/inherits_browser.js","json3":"/node_modules/json3/lib/json3.js","url-parse":"/node_modules/url-parse/index.js"}],"/node_modules/sockjs-client/lib/shims.js":[function(require,module,exports){ /* eslint-disable */ /* jscs: disable */'use strict'; // pulled specific shims from https://github.com/es-shims/es5-shim
...
var string_substr=StringPrototype.substr;var hasNegativeSubstrBug=''.substr && '0b'.substr(-1) !== 'b';defineProperties(StringPrototype,{substr:function substr(start,length){return string_substr.call(this,start < 0?(start = this.length + start) < 0?0:start:start,length);}},hasNegativeSubstrBug);},{}],"/node_modules/sockjs-client/lib/transport-list.js":[function(require,module,exports){'use strict';module.exports = [ // streaming transports
...
var axo=['Active'].concat('Object').join('X');if(!AbstractXHRObject.enabled && axo in global){debug('overriding xmlhttprequest');XHR = function(){try{return new global[axo]('Microsoft.XMLHTTP');}catch(e) {return null;}};AbstractXHRObject.enabled = !!new XHR();}var cors=false;try{cors = 'withCredentials' in new XHR();}catch(ignored) {}AbstractXHRObject.supportsCORS = cors;module.exports = AbstractXHRObject;}).call(this,require('_process'),typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"../../utils/event":"/node_modules/sockjs-client/lib/utils/event.js","../../utils/url":"/node_modules/sockjs-client/lib/utils/url.js","_process":"/node_modules/process/browser.js","debug":"/node_modules/sockjs-client/node_modules/debug/browser.js","events":"/node_modules/sockjs-client/lib/event/emitter.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/transport/browser/eventsource.js":[function(require,module,exports){(function(global){module.exports = global.EventSource;}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{}],"/node_modules/sockjs-client/lib/transport/browser/websocket.js":[function(require,module,exports){(function(global){module.exports = global.WebSocket || global.MozWebSocket;}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{}],"/node_modules/sockjs-client/lib/transport/eventsource.js":[function(require,module,exports){'use strict';var inherits=require('inherits'),AjaxBasedTransport=require('./lib/ajax-based'),EventSourceReceiver=require('./receiver/eventsource'),XHRCorsObject=require('./sender/xhr-cors'),EventSourceDriver=require('eventsource');function EventSourceTransport(transUrl){if(!EventSourceTransport.enabled()){throw new Error('Transport created when disabled');}AjaxBasedTransport.call(this,transUrl,'/eventsource',EventSourceReceiver,XHRCorsObject);}inherits(EventSourceTransport,AjaxBasedTransport);EventSourceTransport.enabled = function(){return !!EventSourceDriver;};EventSourceTransport.transportName = 'eventsource';EventSourceTransport.roundTrips = 2;module.exports = EventSourceTransport;},{"./lib/ajax-based":"/node_modules/sockjs-client/lib/transport/lib/ajax-based.js","./receiver/eventsource":"/node_modules/sockjs-client/lib/transport/receiver/eventsource.js","./sender/xhr-cors":"/node_modules/sockjs-client/lib/transport/sender/xhr-cors.js","eventsource":"/node_modules/sockjs-client/lib/transport/browser/eventsource.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/transport/htmlfile.js":[function(require,module,exports){'use strict';var inherits=require('inherits'),HtmlfileReceiver=require('./receiver/htmlfile'),XHRLocalObject=require('./sender/xhr-local'),AjaxBasedTransport=require('./lib/ajax-based');function HtmlFileTransport(transUrl){if(!HtmlfileReceiver.enabled){throw new Error('Transport created when disabled');}AjaxBasedTransport.call(this,transUrl,'/htmlfile',HtmlfileReceiver,XHRLocalObject);}inherits(HtmlFileTransport,AjaxBasedTransport);HtmlFileTransport.enabled = function(info){return HtmlfileReceiver.enabled && info.sameOrigin;};HtmlFileTransport.transportName = 'htmlfile';HtmlFileTransport.roundTrips = 2;module.exports = HtmlFileTransport;},{"./lib/ajax-based":"/node_modules/sockjs-client/lib/transport/lib/ajax-based.js","./receiver/htmlfile":"/node_modules/sockjs-client/lib/transport/receiver/htmlfile.js","./sender/xhr-local":"/node_modules/sockjs-client/lib/transport/sender/xhr-local.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/transport/iframe.js":[function(require,module,exports){(function(process){'use strict'; // Few cool transports do work only for same-origin. In order to make
...
XDRObject.enabled = !!(global.XDomainRequest && browser.hasDomain());module.exports = XDRObject;}).call(this,require('_process'),typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"../../utils/browser":"/node_modules/sockjs-client/lib/utils/browser.js","../../utils/event":"/node_modules/sockjs-client/lib/utils/event.js","../../utils/url":"/node_modules/sockjs-client/lib/utils/url.js","_process":"/node_modules/process/browser.js","debug":"/node_modules/sockjs-client/node_modules/debug/browser.js","events":"/node_modules/sockjs-client/lib/event/emitter.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/transport/sender/xhr-cors.js":[function(require,module,exports){'use strict';var inherits=require('inherits'),XhrDriver=require('../driver/xhr');function XHRCorsObject(method,url,payload,opts){XhrDriver.call(this,method,url,payload,opts);}inherits(XHRCorsObject,XhrDriver);XHRCorsObject.enabled = XhrDriver.enabled && XhrDriver.supportsCORS;module.exports = XHRCorsObject;},{"../driver/xhr":"/node_modules/sockjs-client/lib/transport/browser/abstract-xhr.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/transport/sender/xhr-fake.js":[function(require,module,exports){'use strict';var EventEmitter=require('events').EventEmitter,inherits=require('inherits');function XHRFake() /* method, url, payload, opts */{var self=this;EventEmitter.call(this);this.to = setTimeout(function(){self.emit('finish',200,'{}');},XHRFake.timeout);}inherits(XHRFake,EventEmitter);XHRFake.prototype.close = function(){clearTimeout(this.to);};XHRFake.timeout = 2000;module.exports = XHRFake;},{"events":"/node_modules/sockjs-client/lib/event/emitter.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/transport/sender/xhr-local.js":[function(require,module,exports){'use strict';var inherits=require('inherits'),XhrDriver=require('../driver/xhr');function XHRLocalObject(method,url,payload /*, opts */){XhrDriver.call(this,method,url,payload,{noCredentials:true});}inherits(XHRLocalObject,XhrDriver);XHRLocalObject.enabled = XhrDriver.enabled;module.exports = XHRLocalObject;},{"../driver/xhr":"/node_modules/sockjs-client/lib/transport/browser/abstract-xhr.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/transport/websocket.js":[function(require,module,exports){(function(process){'use strict';var utils=require('../utils/event'),urlUtils=require('../utils/url'),inherits=require('inherits'),EventEmitter=require('events').EventEmitter,WebsocketDriver=require('./driver/websocket');var debug=function debug(){};if(process.env.NODE_ENV !== 'production'){debug = require('debug')('sockjs-client:websocket');}function WebSocketTransport(transUrl){if(!WebSocketTransport.enabled()){throw new Error('Transport created when disabled');}EventEmitter.call(this);debug('constructor',transUrl);var self=this;var url=urlUtils.addPath(transUrl,'/websocket');if(url.slice(0,5) === 'https'){url = 'wss' + url.slice(5);}else {url = 'ws' + url.slice(4);}this.url = url;this.ws = new WebsocketDriver(this.url);this.ws.onmessage = function(e){debug('message event',e.data);self.emit('message',e.data);}; // Firefox has an interesting bug. If a websocket connection is
...
// absolute minumum.
WebSocketTransport.roundTrips = 2;module.exports = WebSocketTransport;}).call(this,require('_process'));},{"../utils/event":"/node_modules/sockjs-client/lib/utils/event.js","../utils/url":"/node_modules/sockjs-client/lib/utils/url.js","./driver/websocket":"/node_modules/sockjs-client/lib/transport/browser/websocket.js","_process":"/node_modules/process/browser.js","debug":"/node_modules/sockjs-client/node_modules/debug/browser.js","events":"/node_modules/sockjs-client/lib/event/emitter.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/transport/xdr-polling.js":[function(require,module,exports){'use strict';var inherits=require('inherits'),AjaxBasedTransport=require('./lib/ajax-based'),XdrStreamingTransport=require('./xdr-streaming'),XhrReceiver=require('./receiver/xhr'),XDRObject=require('./sender/xdr');function XdrPollingTransport(transUrl){if(!XDRObject.enabled){throw new Error('Transport created when disabled');}AjaxBasedTransport.call(this,transUrl,'/xhr',XhrReceiver,XDRObject);}inherits(XdrPollingTransport,AjaxBasedTransport);XdrPollingTransport.enabled = XdrStreamingTransport.enabled;XdrPollingTransport.transportName = 'xdr-polling';XdrPollingTransport.roundTrips = 2; // preflight, ajax
module.exports = XdrPollingTransport;},{"./lib/ajax-based":"/node_modules/sockjs-client/lib/transport/lib/ajax-based.js","./receiver/xhr":"/node_modules/sockjs-client/lib/transport/receiver/xhr.js","./sender/xdr":"/node_modules/sockjs-client/lib/transport/sender/xdr.js","./xdr-streaming":"/node_modules/sockjs-client/lib/transport/xdr-streaming.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/transport/xdr-streaming.js":[function(require,module,exports){'use strict';var inherits=require('inherits'),AjaxBasedTransport=require('./lib/ajax-based'),XhrReceiver=require('./receiver/xhr'),XDRObject=require('./sender/xdr'); // According to:
...
XhrStreamingTransport.needBody = !!global.document;module.exports = XhrStreamingTransport;}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"../utils/browser":"/node_modules/sockjs-client/lib/utils/browser.js","./lib/ajax-based":"/node_modules/sockjs-client/lib/transport/lib/ajax-based.js","./receiver/xhr":"/node_modules/sockjs-client/lib/transport/receiver/xhr.js","./sender/xhr-cors":"/node_modules/sockjs-client/lib/transport/sender/xhr-cors.js","./sender/xhr-local":"/node_modules/sockjs-client/lib/transport/sender/xhr-local.js","inherits":"/node_modules/inherits/inherits_browser.js"}],"/node_modules/sockjs-client/lib/utils/browser-crypto.js":[function(require,module,exports){(function(global){'use strict';if(global.crypto && global.crypto.getRandomValues){module.exports.randomBytes = function(length){var bytes=new Uint8Array(length);global.crypto.getRandomValues(bytes);return bytes;};}else {module.exports.randomBytes = function(length){var bytes=new Array(length);for(var i=0;i < length;i++) {bytes[i] = Math.floor(Math.random() * 256);}return bytes;};}}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{}],"/node_modules/sockjs-client/lib/utils/browser.js":[function(require,module,exports){(function(global){'use strict';module.exports = {isOpera:function isOpera(){return global.navigator && /opera/i.test(global.navigator.userAgent);},isKonqueror:function isKonqueror(){return global.navigator && /konqueror/i.test(global.navigator.userAgent);}, // #187 wrap document.domain in try/catch because of WP8 from file:///
hasDomain:function hasDomain(){ // non-browser client always has a domain
if(!global.document){return true;}try{return !!global.document.domain;}catch(e) {return false;}}};}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{}],"/node_modules/sockjs-client/lib/utils/escape.js":[function(require,module,exports){'use strict';var JSON3=require('json3'); // Some extra characters that Chrome gets wrong, and substitutes with
...
extraEscapable.lastIndex = 0;if(!extraEscapable.test(quoted)){return quoted;}if(!extraLookup){extraLookup = unrollLookup(extraEscapable);}return quoted.replace(extraEscapable,function(a){return extraLookup[a];});}};},{"json3":"/node_modules/json3/lib/json3.js"}],"/node_modules/sockjs-client/lib/utils/event.js":[function(require,module,exports){(function(global){'use strict';var random=require('./random');var onUnload={},afterUnload=false, // detect google chrome packaged apps because they don't allow the 'unload' event
 ...
 * @return {LocalStorage}
 * @api private
 */function localstorage(){try{return window.localStorage;}catch(e) {}}},{"./debug":"/node_modules/sockjs-client/node_modules/debug/debug.js"}],"/node_modules/sockjs-client/node_modules/debug/debug.js":[function(require,module,exports){ /**
 ...
 * @return {Mixed}
 * @api private
 */function coerce(val){if(val instanceof Error)return val.stack || val.message;return val;}},{"ms":"/node_modules/ms/index.js"}],"/node_modules/url-parse/index.js":[function(require,module,exports){'use strict';var required=require('requires-port'),lolcation=require('./lolcation'),qs=require('querystringify'),relativere=/^\/(?!\/)/; /**
 ...
 * @returns {String}
 * @api public
 */URL.prototype.toString = function toString(stringify){if(!stringify || 'function' !== typeof stringify)stringify = qs.stringify;var query,url=this,result=url.protocol + '//';if(url.username){result += url.username;if(url.password)result += ':' + url.password;result += '@';}result += url.hostname;if(url.port)result += ':' + url.port;result += url.pathname;if(url.query){if('object' === typeof url.query)query = stringify(url.query);else query = url.query;result += (query.charAt(0) === '?'?'':'?') + query;}if(url.hash)result += url.hash;return result;}; //
// Expose the URL parser and some additional properties that might be useful for
// others.
//
URL.qs = qs;URL.location = lolcation;module.exports = URL;},{"./lolcation":"/node_modules/url-parse/lolcation.js","querystringify":"/node_modules/querystringify/index.js","requires-port":"/node_modules/requires-port/index.js"}],"/node_modules/url-parse/lolcation.js":[function(require,module,exports){(function(global){'use strict'; /**
